      ...
      <b-row>
        <b-col lg="6" sm="10" md="10" xs="10" class="wow slideInLeft">
          <dl>
            ...
            <dd class="text-justify">江苏贵阳专业收报废车中心数据技术有限公司（简称贵阳专业收报废车中心）成立于2017年，是国家级高新技术软件企业，专业从事云计算、大数据和智慧城市等领域的产品研发及技术服务；贵阳专业收报废车中心秉持“以人为本、客户至上、生态协作、诚信敬业”的经营理念，从客户实际需求出发，为客户提供行业化的DT、IT设计咨询、方案规划、建设交付、运营维护、综合运营、行业应用软件开发等全方位的解决方案及技术服务。</dd>
